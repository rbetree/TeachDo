# TeachDo 迁移历史计划（ai2ppt → TeachDo）

> 状态：已归档（阶段 A–G 已完成，2026-02-16）
> 当前开发计划入口：`doc/dev/PLAN.md`

## 0. 文档说明（已归档）
- 本文记录 ai2ppt → TeachDo 迁移与重构（阶段 A–G）的计划与执行过程，供后续回溯与对照使用。
- 当前与后续开发计划请以 `doc/dev/PLAN.md` 为准。

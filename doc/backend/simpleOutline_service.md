...
`simpleOutline` 是 AI2PPT 项目中负责生成演示文稿大纲的核心服务。它基于 **Google ADK (Agent Development Kit)** 框架和 **A2A (Agent-to-Agent)** 协议构建，接收用户提供的主题或参考内容，通过智能分析和可选的网络搜索，生成结构化的 Markdown 大纲。
...
`simpleOutline` 服务是 AI2PPT 项目的核心组件之一，负责将用户的简短主题或长文档转换为结构化的演示文稿大纲。其主要特点包括：

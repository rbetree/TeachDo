...
6. 严禁保留或轻微改写任何 scaffold/占位文案。以下内容仅是初始化 seed，最终输出绝对禁止出现：`Detailed content about ...`、`A presentation generated by AI`、`Exploring the topic of ...`。一旦出现，必须用真实、完整、面向演示的文案替换。
"""
...
7. 严禁保留或轻微改写任何 scaffold/占位文案。以下内容仅是初始化 seed，最终输出绝对禁止出现：`Detailed content about ...`、`A presentation generated by AI`、`Exploring the topic of ...`。一旦出现，必须用真实、完整、面向演示的文案替换。

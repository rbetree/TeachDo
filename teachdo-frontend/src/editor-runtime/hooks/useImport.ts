...
import { decrypt } from '@editor/utils/crypto'
...
import { getSvgPathRange } from '@editor/utils/svgPathParser'
import type {
  Slide,
  TableCellStyle,
  TableCell,
    ...
    reader.onload = async e => {
      ...
      for (const item of json.slides) {
        ...
        if (type === 'image') {
          ...
          background = {
            type: 'solid',
            color: typeof value === 'string' ? value : (value as any)?.backgroundColor || '#fff',
          }
        }

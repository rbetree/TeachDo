...
import type { PPTElement, PPTImageElement, PPTLineElement, PPTShapeElement } from '@editor/types/slides'
import { OperateResizeHandlers, type AlignmentLineProps, type MultiSelectRange } from '@editor/types/edit'
import { MIN_SIZE } from '@editor/configs/element'
import { SHAPE_PATH_FORMULAS } from '@editor/configs/shapes'
import { type AlignLine, uniqAlignLines } from '@editor/utils/element'

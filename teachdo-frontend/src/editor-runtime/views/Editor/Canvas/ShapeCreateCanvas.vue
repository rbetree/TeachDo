<template>
  ...
  >
    <svg overflow="visible">
        ...
        :d="path" 
        stroke="#000000" 
        :fill="closed ? 'rgba(0, 0, 0, 0.06)' : 'none'" 
        stroke-width="2" 
      ></path>
		</svg>
  </div>
...
import { useKeyboardStore, useMainStore, useSlidesStore } from '@editor/store'
import type { CreateCustomShapeData } from '@editor/types/edit'

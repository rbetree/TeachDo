  ...
  <div class="shape-element-operate">
    ...
    <template v-if="handlerVisible">
      ...
      <RotateHandler
        ...
        @mousedown.stop="(e: MouseEvent) => rotateElement(e, elementInfo)"
      />
      <div 
        ...
        @mousedown.stop="(e: MouseEvent) => moveShapeKeypoint(e, elementInfo, index)"
      ></div>
    </template>
  </div>
</template>
...
import type { PPTShapeElement } from '@editor/types/slides'
import type { OperateResizeHandlers } from '@editor/types/edit'

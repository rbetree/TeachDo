...
import type { LinePoint, LineStyleType } from '@editor/types/slides'
import LinePointMarker from '@editor/views/components/element/LineElement/LinePointMarker.vue'

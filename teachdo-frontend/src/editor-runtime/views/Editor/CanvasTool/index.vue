...
import { useMainStore, useSnapshotStore } from '@editor/store'
import { getImageDataURL } from '@editor/utils/image'
import type { ShapePoolItem } from '@editor/configs/shapes'
import type { LinePoolItem } from '@editor/configs/lines'
...
import LaTeXEditor from '@editor/components/LaTeXEditor/index.vue'

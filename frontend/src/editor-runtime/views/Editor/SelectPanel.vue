...
import { useSlidesStore, useMainStore } from '@editor/store'
import type { PPTElement } from '@editor/types/slides'
import { ELEMENT_TYPE_ZH } from '@editor/configs/element'
import useOrderElement from '@editor/hooks/useOrderElement'
import useHideElement from '@editor/hooks/useHideElement'
import useSelectElement from '@editor/hooks/useSelectElement'
import { ElementOrderCommands } from '@editor/types/edit'

import MoveablePanel from '@editor/components/MoveablePanel.vue'

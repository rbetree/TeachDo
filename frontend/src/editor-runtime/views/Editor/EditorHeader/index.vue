            ...
            <div class="import-section">
              ...
              <div class="import-grid">
                <FileInput class="import-block" accept="application/vnd.openxmlformats-officedocument.presentationml.presentation" @change="files => {
                  ...
                  <span class="icon"><IconFilePdf theme="multi-color" :fill="['#111111', '#000000', '#ffffff']" /></span>
                ...
                <FileInput class="import-block" accept=".json" @change="files => {
                  ...
                  <span class="icon"><IconFileJpg theme="multi-color" :fill="['#111111', '#000000', '#ffffff']" /></span>
                ...
                <FileInput class="import-block" accept=".pptist" @change="files => {
                  ...
                  <span class="icon"><IconNotes theme="multi-color" :fill="['#111111', '#000000', '#ffffff']" /></span>
...
import useImport from '@editor/hooks/useImport'
import useSlideHandler from '@editor/hooks/useSlideHandler'
import useHistorySnapshot from '@editor/hooks/useHistorySnapshot'
import type { DialogForExportTypes } from '@editor/types/export'
import type { AIPPTSlide } from '@editor/types/AIPPT'
import message from '@editor/utils/message'

import HotkeyDoc from './HotkeyDoc.vue'
import FileInput from '@editor/components/FileInput.vue'
import FullscreenSpin from '@editor/components/FullscreenSpin.vue'
import Drawer from '@editor/components/Drawer.vue'
import Input from '@editor/components/Input.vue'
...
.aippt-form {
  ...
  .label { font-size: 12px; color: #555555; margin-bottom: 6px; }
  .aippt-textarea {
    width: 100%;
    height: 300px;
    resize: vertical;

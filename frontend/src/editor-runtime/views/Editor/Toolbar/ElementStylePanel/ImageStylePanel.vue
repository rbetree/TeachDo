...
import type { PPTImageElement, SlideBackground } from '@editor/types/slides'
import { CLIPPATHS } from '@editor/configs/imageClip'
import { getImageDataURL, getImageSize } from '@editor/utils/image'

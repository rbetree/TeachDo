...
import type { GradientType, PPTShapeElement, Gradient, ShapeText } from '@editor/types/slides'
import { type ShapePoolItem, SHAPE_LIST, SHAPE_PATH_FORMULAS } from '@editor/configs/shapes'
import { getImageDataURL } from '@editor/utils/image'
import emitter, { EmitterEvents } from '@editor/utils/emitter'
import useHistorySnapshot from '@editor/hooks/useHistorySnapshot'
import useShapeFormatPainter from '@editor/hooks/useShapeFormatPainter'
...
import ShapeItemThumbnail from '@editor/views/Editor/CanvasTool/ShapeItemThumbnail.vue'
import ColorButton from '@editor/components/ColorButton.vue'
import CheckboxButton from '@editor/components/CheckboxButton.vue'
import ColorPicker from '@editor/components/ColorPicker/index.vue'
import Divider from '@editor/components/Divider.vue'
import Slider from '@editor/components/Slider.vue'
import RadioButton from '@editor/components/RadioButton.vue'
import RadioGroup from '@editor/components/RadioGroup.vue'
import Select from '@editor/components/Select.vue'
import Popover from '@editor/components/Popover.vue'
import GradientBar from '@editor/components/GradientBar.vue'
import FileInput from '@editor/components/FileInput.vue'

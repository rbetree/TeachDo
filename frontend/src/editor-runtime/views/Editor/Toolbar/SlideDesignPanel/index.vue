...
import ColorListButton from '@editor/components/ColorListButton.vue'
...
import Button from '@editor/components/Button.vue'
import Select from '@editor/components/Select.vue'
import Popover from '@editor/components/Popover.vue'
import SelectCustom from '@editor/components/SelectCustom.vue'
import NumberInput from '@editor/components/NumberInput.vue'

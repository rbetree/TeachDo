...
import type { LineStyleType, PPTElement, PPTElementOutline, TableCell } from '@editor/types/slides'
...
import ButtonGroup from '@editor/components/ButtonGroup.vue'
...
import SelectGroup from '@editor/components/SelectGroup.vue'

...
import type { PPTShapeElement, ShapeText } from '@editor/types/slides'
import type { ContextmenuItem } from '@editor/components/Contextmenu/types'
import useElementOutline from '@editor/views/components/element/hooks/useElementOutline'
import useElementShadow from '@editor/views/components/element/hooks/useElementShadow'
import useElementFlip from '@editor/views/components/element/hooks/useElementFlip'
import useElementFill from '@editor/views/components/element/hooks/useElementFill'
import useHistorySnapshot from '@editor/hooks/useHistorySnapshot'

import GradientDefs from './GradientDefs.vue'
import PatternDefs from './PatternDefs.vue'
import ProsemirrorEditor from '@editor/views/components/element/ProsemirrorEditor.vue'

...
import { useMainStore, useKeyboardStore } from '@editor/store'
import { KEYS } from '@editor/configs/hotkey'
import { type ImageClipedEmitData, OperateResizeHandlers } from '@editor/types/edit'
import type { ImageClipDataRange, ImageElementClip } from '@editor/types/slides'

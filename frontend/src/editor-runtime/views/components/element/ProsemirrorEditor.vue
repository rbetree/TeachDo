...
import { useKeyboardStore, useMainStore } from '@editor/store'
import type { EditorView } from 'prosemirror-view'
import { toggleMark, wrapIn, lift } from 'prosemirror-commands'
import { initProsemirrorEditor, createDocument } from '@editor/utils/prosemirror'
import { isActiveOfParentNodeType, findNodesWithSameMark, getTextAttrs, autoSelectAll, addMark, markActive, getFontsize } from '@editor/utils/prosemirror/utils'
import emitter, { EmitterEvents, type RichTextAction, type RichTextCommand } from '@editor/utils/emitter'
import { alignmentCommand } from '@editor/utils/prosemirror/commands/setTextAlign'
import { indentCommand, textIndentCommand } from '@editor/utils/prosemirror/commands/setTextIndent'
import { toggleList } from '@editor/utils/prosemirror/commands/toggleList'
import { setListStyle } from '@editor/utils/prosemirror/commands/setListStyle'
import { replaceText } from '@editor/utils/prosemirror/commands/replaceText'
import type { TextFormatPainterKeys } from '@editor/types/edit'
import message from '@editor/utils/message'
import { KEYS } from '@editor/configs/hotkey'

...
<template>
  ...
  >
      ...
      <div v-else class="flex items-center justify-between gap-2 p-2">
        ...
        <div class="flex items-center gap-1">
          ...
          >
            ...
            <span class="text-sm font-bold">{{ t('workspace.references.title') }}</span>
          </button>
    ...
    <div v-if="!collapsed" class="flex-1 min-h-0 overflow-hidden">
      <KnowledgeBaseView v-if="activeTab === 'kb'" variant="panel" :current-material="props.currentMaterial" source-filter="uploaded" />
